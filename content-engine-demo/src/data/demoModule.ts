/**
 * Demo module – printf/format-string lecture.
 * Segments: 0–6 (basics), 7–13 (CIA + attacks), 14–end (fixes, overflow, injection).
 * 5 MCQs per segment.
 */
...
export const demoModule: ModuleConfig = {
  ...
  // Segment 0 ends 10:30 (pages 0–6), Segment 1 ends 25:25 (pages 7–13), Segment 2 to end
  segments: [
